...
func doDocker(cmdline []string) {
	var (
		...
		upload   = flag.String("upload", "", `Where to upload the docker image (usually "expanse-org/client-go")`)
	)
	flag.CommandLine.Parse(cmdline)
	...
	//  - expanse-org/client-go:latest                            - Pushes to the master branch, Geth only
	//  - expanse-org/client-go:stable                            - Version tag publish on GitHub, Geth only
	//  - expanse-org/client-go:alltools-latest                   - Pushes to the master branch, Geth & tools
	//  - expanse-org/client-go:alltools-stable                   - Version tag publish on GitHub, Geth & tools
	//  - expanse-org/client-go:release-<major>.<minor>           - Version tag publish on GitHub, Geth only
	//  - expanse-org/client-go:alltools-release-<major>.<minor>  - Version tag publish on GitHub, Geth & tools
	//  - expanse-org/client-go:v<major>.<minor>.<patch>          - Version tag publish on GitHub, Geth only
	//  - expanse-org/client-go:alltools-v<major>.<minor>.<patch> - Version tag publish on GitHub, Geth & tools
	var tags []string
